...
#   make musl         - download and build musl for i386 into $(MUSL_PREFIX)
#   make clean        - remove build artefacts
#
# Variables (override on command line):
#   MUSL_PREFIX       - path to an installed musl sysroot
#                       (default: build/musl)
#   BUILD_DIR         - output directory (default: build)
#   DEBUG=1           - enable debug flags (-g -O0 -DDEBUG)
#
# Quick start:
#   make musl            # builds musl for i386 into build/musl/
#   make                 # builds matey (static i386 ELF)
#
# Or with a custom musl sysroot:
#   make MUSL_PREFIX=/opt/musl-i386
#
...
# ---------------------------------------------------------------------------
# musl — download and build musl libc for i386
# ---------------------------------------------------------------------------
musl:
...
help:
	...
	@echo "  make musl         download and build musl for i386 (into MUSL_PREFIX)"
	...
	@echo ""
	@echo "Example:"
	@echo "  make MUSL_PREFIX=/opt/musl-i386"
